...
import static org.openhab.binding.hapcan.HapcanBindingConstants.EXTENDED_CHANNELS_BUTTONS;
 ...
 */
@NonNullByDefault
public class HapcanButtonHandler extends HapcanThingHandler {

    public HapcanButtonHandler(Thing thing) {
        super(thing);
    }

    private boolean hasExtendedChannels() {
        return EXTENDED_CHANNELS_BUTTONS.contains(thing.getThingTypeUID());
    }
